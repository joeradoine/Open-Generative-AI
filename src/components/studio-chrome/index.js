...
const NAV_ITEMS = [
  ...
  { key:'cinema',       href:'/ivamind/cinema',        label:'Cinema Studio', icon:I.video,    badge:'new', hint: 'Higgsfield-style · gallery + floating Director Panel + @mentions auto-lock' },
  ...
  { key:'cinema-legacy',href:'/studio/cinema',         label:'Cinema Studio', icon:I.video,    badge:null, hint: 'Legacy — contrôles pro lens/focal/aperture BYOK' },
