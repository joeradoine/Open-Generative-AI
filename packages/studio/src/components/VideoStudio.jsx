...
const VideoReadySvg = () => (
  ...
  >
    <polygon points="23 7 16 12 23 17 23 7" />
    <rect x="1" y="5" width="15" height="14" rx="2" ry="2" />
    <polyline points="7 10 10 13 15 8" stroke="#f9b233" strokeWidth="2.5" />
  </svg>
);
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-2 border-t border-white/[0.03] relative">
            <div className="flex items-center gap-2 relative flex-wrap pb-1 md:pb-0">
              ...
              <div className="relative">
                ...
                >
                  <div className="w-4 h-4 bg-[#f9b233] rounded flex items-center justify-center shadow-lg shadow-[#f9b233]/10">
                    <span className="text-[9px] font-bold text-black uppercase">
                      V
                    </span>
                  </div>
                  <span className="text-xs font-semibold text-white/70 group-hover:text-[#f9b233] transition-colors">
                    {selectedModelName}
                  </span>
                  <svg
                    width="8"
              ...
              {showAr && (
                <div className="relative">
                  ...
                  >
                    ...
                    <span className="text-[11px] font-semibold text-white/70 group-hover:text-[#f9b233] transition-colors">
                      {selectedAr}
                    </span>
                  </button>
                  {openDropdown === "ar" && (
            ...
            <button
              ...
              disabled={generating}
              className="bg-[#f9b233] text-black px-4 py-2 rounded-md font-medium text-sm hover:bg-[#fbc84a] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 w-full sm:w-auto shadow-lg shadow-[#f9b233]/10 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {generating ? (
                <>
